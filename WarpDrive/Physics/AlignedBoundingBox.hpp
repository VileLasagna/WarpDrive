#ifndef ALIGNEDBBOX_HPP_DEFINED
#define ALIGNEDBBOX_HPP_DEFINED
...
public:
    ...
    void Set(float newxmin, float newxmax, float newymin, float newymax, float newzmin, float newzmax);
